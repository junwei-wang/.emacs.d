(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (sumatra-forward markdown-mode magit auctex fullframe)))
 '(safe-local-variable-values
   (quote
    ((TeX-command-extra-options . " -interaction=batchmode -shell-escape --synctex=1")
     (TeX-command-extra-options . "-shell-escape --synctex=1 -interaction=batchmode")
